export const content = {
  ...
  chemistry: {
    ...
    body: [
      "Over 90% of our active chemistry is bio-derived or green-classified — sourced at the leading edge of sustainable formulation.",
  ...
  industries: {
    ...
    panels: [
      {
        number: "01",
        title: "Ink manufacturing",
        pain: "Aggressive solvent wash between every colour change.",
      },
      {
        number: "02",
        title: "Lithographic printing",
        pain: "Hazardous blanket and roller washes, every shift.",
      },
      {
        number: "03",
        title: "Resin manufacturing",
        pain: "Baked-on residue that only the harshest chemistry shifts.",
      },
      {
        number: "04",
  ...
  partner: {
    ...
    steps: [
      {
        title: "Kick Off",
        desc: "We learn your operation, your products, your cleaning challenges.",
      },
      {
        title: "Product Testing",
        desc: "You send us your product. We test blent against it in our lab and share every result.",
      },
      {
        title: "Trial",
        desc: "We come to you. Real conditions, real surfaces, full support.",
      },
      {
        title: "Roll Out",
